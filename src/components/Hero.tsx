...
import FloatingFoodAnimation from './FloatingFoodAnimation';
    ...
    >
      ...
      <div className="absolute inset-0 bg-bg-secondary">
        <img
          ...
          loading="eager"
        />
        <div className="absolute inset-0 bg-gradient-to-br from-bg-secondary/80 via-bg-primary/60 to-bg-secondary/90" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Subtitle */}
            <p className="text-text-secondary text-base sm:text-lg leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
            ...
            {/* Info Pills */}
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-text-secondary text-sm lg:justify-start justify-center">
          ...
          {/* Right: Floating Food Animation */}
          <div className="hidden lg:block">
            <FloatingFoodAnimation />
          </div>
        </div>

        {/* Mobile: Floating Food (below text) */}
